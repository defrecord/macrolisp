...
1. Clone the repository:
   ```bash
   git clone https://github.com/defrecord/macrolisp.git
   cd macrolisp
   ```
...
## Community
- [GitHub Discussions](https://github.com/defrecord/macrolisp/discussions)
- [Issue Tracker](https://github.com/defrecord/macrolisp/issues)
